...
public class Tags extends Model {
    ...
    public Picture getTaggedPicture() {return taggedPicture;}
    public void setTaggedPicture(Picture taggedPicture) {this.taggedPicture = taggedPicture;}
    public Tag getTagOfPicture() {return tagOfPicture;}
    public void setTagOfPicture(Tag tagOfPicture) {this.tagOfPicture = tagOfPicture;}
}
